...
public class MimingWriter extends Library
{
    ...
    public void loop()
    {
        ...
        try
        {
            FileWriter writer = new FileWriter("GitHub/T-10-actual-19-20/FtcRobotController/src/main/java/org/firstinspires/ftc/robotcontroller/internal/MimingFile.txt", true);
