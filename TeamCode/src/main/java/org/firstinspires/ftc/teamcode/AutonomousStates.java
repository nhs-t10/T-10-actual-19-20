    ...
    public String basicQuarryAuto()
    {
        switch(states)
        {
            case DRIVE_TO_STARTING_POS:
                driveForEncoders(DISTANCE_UNTIL_CAMERA_SEES_ONE_STONE, .5f);
            ...
            case DRIVE_TO_QUARRY:
                driveForEncoders(DISTANCE_FROM_SIDE_WALL_TO_QUARRY - DISTANCE_UNTIL_CAMERA_SEES_ONE_STONE, .5f);
                return "PICKUP_STONE";
            ...
            case DRIVE_TO_FOUNDATION:
                driveForEncoders(DISTANCE_FROM_QUARRY_TO_FOUNDATION, .5f);
